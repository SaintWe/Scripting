...
import { fetchBannerImage, getChangelog, getCurrentVersion, getLocalVersionInfo, markUpdateLogDismissed, shouldShowUpdateLog } from '../utils/version-service'
            ...
            footer={
                <VStack spacing={10} alignment="leading">
                    ...
                    <Text font="footnote" foregroundStyle="secondaryLabel">
                        {scriptConfig.name} v{getCurrentVersion()}
                        {'\n'}
